...
class ShoppingCart(models.Model):
    ...
    购物车
    """
    username = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE, verbose_name="用户")
    ...
    class Meta:
        ...
        unique_together = ("username", "goods")
...
class OrderInfo(models.Model):
    ...
    username = models.ForeignKey(settings.AUTH_USER_MODEL,related_name='MyUser_set', on_delete=models.CASCADE, verbose_name="用户")
    #订单号唯一
