...
class GoodsType(BaseModel):
    '''商品模型类'''
    name = models.CharField(max_length=20,verbose_name='模型种类')
    logo = models.CharField(max_length=20,verbose_name='模型标识')
...
class GoodsSku(BaseModel):
    ...
    desc = models.CharField(max_length=512,verbose_name='商品简介')
...
class IndexGoodsBanner(BaseModel):
    ...
    order = models.SmallIntegerField(default=0,verbose_name='展示顺序')
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1,choices=display_type_choices,verbose_name='标题类型')
    order = models.SmallIntegerField(default=0, verbose_name='展示顺序')
